...
If you've updated the TypeScript declaration file (`/src/types.d.ts`), you should add some lines verifying the updates in `/ts-tests/index.ts` and then run the TypeScript compilation test using the `npm run test-ts-decls` command.
