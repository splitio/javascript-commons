...
export const ALWAYS_ON_SPLIT: IDefinition = { 'trafficTypeName': 'user', 'name': 'always-on', 'trafficAllocation': 100, 'trafficAllocationSeed': 1012950810, 'seed': -725161385, 'status': 'ACTIVE', 'killed': false, 'defaultTreatment': 'off', 'changeNumber': 1494364996459, 'conditions': [{ 'conditionType': 'ROLLOUT', 'matcherGroup': { 'combiner': 'AND', 'matchers': [{ 'keySelector': { 'trafficType': 'user', 'attribute': null }, 'matcherType': 'ALL_KEYS', 'negate': false, 'userDefinedSegmentMatcherData': null, 'whitelistMatcherData': null, 'unaryNumericMatcherData': null, 'betweenMatcherData': null }] }, 'partitions': [{ 'treatment': 'on', 'size': 100 }, { 'treatment': 'off', 'size': 0 }], 'label': 'in segment all' }], 'sets': [] };
export const ALWAYS_OFF_SPLIT: IDefinition = { 'trafficTypeName': 'user', 'name': 'always-off', 'trafficAllocation': 100, 'trafficAllocationSeed': -331690370, 'seed': 403891040, 'status': 'ACTIVE', 'killed': false, 'defaultTreatment': 'on', 'changeNumber': 1494365020316, 'conditions': [{ 'conditionType': 'ROLLOUT', 'matcherGroup': { 'combiner': 'AND', 'matchers': [{ 'keySelector': { 'trafficType': 'user', 'attribute': null }, 'matcherType': 'ALL_KEYS', 'negate': false, 'userDefinedSegmentMatcherData': null, 'whitelistMatcherData': null, 'unaryNumericMatcherData': null, 'betweenMatcherData': null }] }, 'partitions': [{ 'treatment': 'on', 'size': 0 }, { 'treatment': 'off', 'size': 100 }], 'label': 'in segment all' }], 'sets': [] }; //@ts-ignore
export const splitWithUserTT: IDefinition = { name: 'user_ff', trafficTypeName: 'user_tt', conditions: [] }; //@ts-ignore
export const splitWithAccountTT: IDefinition = { name: 'account_ff', trafficTypeName: 'account_tt', conditions: [] }; //@ts-ignore
export const splitWithAccountTTAndUsesSegments: IDefinition = { trafficTypeName: 'account_tt', conditions: [{ matcherGroup: { matchers: [{ matcherType: 'IN_SEGMENT', userDefinedSegmentMatcherData: { segmentName: 'employees' } }] } }] }; //@ts-ignore
export const something: IDefinition = { name: 'something' }; //@ts-ignore
export const somethingElse: IDefinition = { name: 'something else' };

// - With flag sets

//@ts-ignore
export const featureFlagWithEmptyFS: IDefinition = { name: 'ff_empty', sets: [] };
//@ts-ignore
export const featureFlagOne: IDefinition = { name: 'ff_one', sets: ['o', 'n', 'e'] };
//@ts-ignore
export const featureFlagTwo: IDefinition = { name: 'ff_two', sets: ['t', 'w', 'o'] };
//@ts-ignore
export const featureFlagThree: IDefinition = { name: 'ff_three', sets: ['t', 'h', 'r', 'e'] };
//@ts-ignore
export const featureFlagWithoutFS: IDefinition = { name: 'ff_four' };
