...
export const debugLogger = new Logger('splitio', { logLevel: 'DEBUG' }, new _Map(codesError.concat(codesWarn).concat(codesInfo).concat(codesDebug).concat(codesDebugBrowser)));
