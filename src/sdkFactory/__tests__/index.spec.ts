...
function assertModulesCalled(params: any) {
  ...
  if (params.serviceApiFactory) {
    expect(params.serviceApiFactory.mock.calls).toEqual([[params.settings, params.platform, telemetryTrackerMock]]);
  }
