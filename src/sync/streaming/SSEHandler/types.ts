...
import { SEGMENT_UPDATE, SPLIT_UPDATE, CONFIG_UPDATE, SPLIT_KILL, CONTROL, OCCUPANCY, MEMBERSHIPS_LS_UPDATE, MEMBERSHIPS_MS_UPDATE, RB_SEGMENT_UPDATE } from '../types';
...
export interface ISplitUpdateData {
  type: SPLIT_UPDATE | CONFIG_UPDATE | RB_SEGMENT_UPDATE,
  changeNumber: number,
  pcn?: number,
  d?: string,
  c?: Compression
