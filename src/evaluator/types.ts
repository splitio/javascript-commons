...
export type ISplitEvaluator = (key: SplitIO.SplitKey, splitName: string, attributes: SplitIO.Attributes, storage: IStorageSync | IStorageAsync, log: ILogger) => MaybeThenable<IEvaluation>
